...
- **Start the yeast**. For any recipe using dry yeast, mix the yeast with warm water (about 110˚F). Let it stand for 5-10 min, until foamy. This may not always be necessary, but it will help activate the yeast. Yeast can die in the refrigerator too, so be mindful of how old it is. If a recipe calls for sugar, adding a little of that at this stage can speed the process.
...
- **Knead by hand**. I really didn't understand how to do this correctly for a long time. Knead in such a way that you're folding the dough. Push it away to stretch it out, then grab the far edge and fold it back. Turn the dough 90˚ and repeat. Ten to 15 minutes of this is typically adequate.
- **Proofing times** will vary based on temperature and any inhibitory ingredients. This process will be exponential, then plateau, causing the dough to collapse. Ideally, you want to end the proof while the yeast is still vigorous, after the dough has achieved the size you want and before any collapse. But you must consider both time and temperature. -- Here's a [reference on proofing](https://challengerbreadware.com/bread-techniques/identifying-proofing-levels-in-baked-bread/). Advice: keep the dough somewhere warm, give it at least an hour, and watch it after that at 15-20 minute intervals.
